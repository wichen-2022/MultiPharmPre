...
parser.add_argument('--pretrain', default='E:/MyPythonWorkSpace/tensorflow_2.7.0/RG-MPNN-main/GNN/MyNets/pretrain/RGNN_best_model.ckp', help='if True give checkpoints path')
...
dataset_params = {
    # ... 其他参数 ...
    #'root': 'E:/MyPythonWorkSpace/tensorflow_2.7.0/RG-MPNN-main/data/ClinTox',  # 修改为新的路径
    'root': 'E:/MyPythonWorkSpace/tensorflow_2.7.0/RG-MPNN-main/data/hiv',
    # ... 其他参数 ...
    'raw_name': 'hiv.csv',
    'target_idxs':1,
...
def train(epoch, dataloader, rg_dataloader):
    ...
    for data,rg_data in zip(dataloader,rg_dataloader):
        ...
        mask = (y == 1) | (y == 0)  # 创建掩码，选择有效的样本
        y = y[mask]# 应用掩码到标签
        out = out[mask]  # 应用掩码到模型输出
...
#print('train_dataset.label:', train_dataset.label)
